...
[![Typing SVG](https://readme-typing-svg.herokuapp.com/?color=00bfbf&size=35&center=true&vCenter=true&width=1000&lines=Hello,+I'm+Luís+Davi+Gomes+de+Santana;Data+Science+Student+%7C+ETL+%7C+ML+%7C+GenAI;Back-End+Developer;Welcome!)](https://git.io/typing-svg)
...
Tenho forte interesse em **IA aplicada ao negócio**, especialmente usando ferramentas modernas como Python, SQL, TensorFlow, PyTorch e soluções em Cloud.
...
### **ETEC – Projeto FinUnsize (Plataforma de Estoques e Finanças)**
**Analista de Sistemas (Jan 2023 — Jul 2023)**  
- Criação de diagramas, modelos e requisitos do sistema.  
- Análise de concorrentes e pesquisa aplicada.  

**Analista Desenvolvedor Back-End Mobile (Jul 2023 — Dez 2023)**  
- Desenvolvimento do app em **Android Studio + Java**.  
- Integração com API e trabalho colaborativo via Trello.

---

## 🌐 Contato
📧 **E-mail:** luisdavigomesdesantana@outlook.com  
🔗 **LinkedIn:** https://linkedin.com/in/luisdavigsantana  
🐙 **GitHub:** https://github.com/luisDaviSantana  
